    ...
    try:
        ...
        if args.branch is not None and args.date is not None and args.timezone is not None:
            ...
            if args.date == "current":
                ...
                generator = ManifestGenerator(dest_manifest, args.branch, args.builddir, git_credential=args.git_credential, jobs=args.jobs, force=args.force, template=args.template)
            else:
