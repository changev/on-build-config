...
def runTest(String stack_type, String test_name, ArrayList<String> used_resources, Map ova_dict, boolean keep_env_on_failure, int keep_minutes,String use_prebuilt_ova="false"){
    def shareMethod = new pipeline.common.ShareMethod()
    ...
    try{
        lock(label:label_name,quantity:1){
            ...
            node(node_name){
                ...
                String ova_path = ""
                if (use_prebuilt_ova == "true"){
                    ova_path = ova_dict["ova_url"]
                } else {
